<footer class="relative h-20 flex justify-around items-center shadow-md w-full">
  <!-- Navigation items -->
  <section class="flex w-full justify-between px-6 mb-5">
    <!-- Home -->
    <a href="/main">
    ...
    <a href="/gallery">
      <button class="flex flex-col items-center">
        <img
          width="30"
          height="30"
          src="https://img.icons8.com/ios/50/museum.png"
          alt="museum"
        />
        <!-- <span class="text-sm font-medium">Museum</span> -->
      </button>
    </a>
    ...
    <a href="/challenges">
      <button class="flex flex-col items-center">
        <img
          width="30"
          height="30"
          src="https://img.icons8.com/external-febrian-hidayat-detailed-outline-febrian-hidayat/64/external-Chest-fantasy-and-rpg-febrian-hidayat-detailed-outline-febrian-hidayat-4.png"
          alt="external-Chest-fantasy-and-rpg-febrian-hidayat-detailed-outline-febrian-hidayat-4"
        />
    ...
    <!-- <a href="/profile">
      <button class="flex flex-col items-center">
        <img
          width="30"
          height="30"
          src="https://img.icons8.com/fluency-systems-regular/96/user--v1.png"
          alt="user--v1"
        />
